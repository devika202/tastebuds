  ...
  it 'renders the form' do
    ...
    assert_select 'form[action=?][method=?]', shop_sales_reports_path, 'post' do
      assert_select 'div.form-group.row.form-label' do
        assert_select 'label.col-2.col-form-label.text-dark[for=?]', 'sales_report_product_name', text: /Product Name/i, count: 1
      ...
      assert_select 'div.form-group.row.form-label' do
        assert_select 'label.col-2.col-form-label.text-dark[for=?]', 'sales_report_price', text: /Price/i, count: 1
      ...
      assert_select 'div.form-group.row.form-label' do
        assert_select 'label.col-2.col-form-label.text-dark[for=?]', 'sales_report_weight', text: /Weight/i, count: 1
      ...
      assert_select 'div.form-group.row.form-label' do
        assert_select 'label.col-2.col-form-label.text-dark[for=?]', 'sales_report_quantity', text: /Quantity/i, count: 1
      ...
      assert_select 'div.form-group.row.form-label' do
        assert_select 'label.col-2.col-form-label.text-dark[for=?]', 'sales_report_total_price', text: /Total Price/i, count: 1
      ...
      assert_select 'div.form-group.row.form-label' do
        assert_select 'label.col-2.col-form-label.text-dark[for=?]', 'sales_report_date_of_purchase', text: /Date of Purchase/i, count: 1
      ...
      assert_select 'div.form-group.row.form-label' do
        assert_select 'label.col-2.col-form-label.text-dark[for=?]', 'sales_report_category_id', text: /Category/i, count: 1
